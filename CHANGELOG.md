...
- fix: exception thrown in remove_old_cached_files

## 4.1.0 (2025-09-19)


- feat: Added test for remove_old_cached_files method
- feat: Add tests for simple_cache.py
- Co-authored-by: aider (vertex_ai/gemini-2.0-flash-001) <aider@aider.chat>
- feat: Add initial test file for simple cache
- feat: Add last access tracking to simple cache
...
- fix: if we have a default index, don't reset_index
- fix!: reading parquet tables will return table with index as normal columns
